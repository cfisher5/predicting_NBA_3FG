...
# scraper.get_draft_class_ids("https://www.basketball-reference.com/draft/NBA_2017.html", "data/2017draft.csv")
# scraper.sports_ref_scrape("https://www.sports-reference.com/cbb/play-index/psl_finder.cgi?request=1&match=combined&year_min=2012&year_max=2017&conf_id=&school_id=&class_is_fr=Y&class_is_so=Y&class_is_jr=Y&class_is_sr=Y&pos_is_g=Y&pos_is_gf=Y&pos_is_fg=Y&pos_is_f=Y&pos_is_fc=Y&pos_is_cf=Y&pos_is_c=Y&games_type=A&qual=&c1stat=&c1comp=&c1val=&c2stat=&c2comp=&c2val=&c3stat=&c3comp=&c3val=&c4stat=&c4comp=&c4val=&order_by=fg_pct&order_by_asc=&offset=", "data/ncaa_last_5_years.csv")
# combine_data.filter_data('data/2017draft.csv', 2, 'data/ncaa_last_5_years.csv', 0, 'data/2017draft_stats.csv')